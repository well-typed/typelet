...
import Test.Size.Ap.Index.Ix100
import Test.Size.Setup

applyF :: forall f r. Applicative f => F r -> f r
applyF f =
    -- 99 .. 90
    case letT (Proxy @(T "i99" -> r))   of { LetT (_ :: Proxy l99) ->
    case letT (Proxy @(T "i98" -> l99)) of { LetT (_ :: Proxy l98) ->
    case letT (Proxy @(T "i97" -> l98)) of { LetT (_ :: Proxy l97) ->
    case letT (Proxy @(T "i96" -> l97)) of { LetT (_ :: Proxy l96) ->
    case letT (Proxy @(T "i95" -> l96)) of { LetT (_ :: Proxy l95) ->
    case letT (Proxy @(T "i94" -> l95)) of { LetT (_ :: Proxy l94) ->
    case letT (Proxy @(T "i93" -> l94)) of { LetT (_ :: Proxy l93) ->
    case letT (Proxy @(T "i92" -> l93)) of { LetT (_ :: Proxy l92) ->
    case letT (Proxy @(T "i91" -> l92)) of { LetT (_ :: Proxy l91) ->
    case letT (Proxy @(T "i90" -> l91)) of { LetT (_ :: Proxy l90) ->
    -- 89 .. 80
    case letT (Proxy @(T "i89" -> l90)) of { LetT (_ :: Proxy l89) ->
    case letT (Proxy @(T "i88" -> l89)) of { LetT (_ :: Proxy l88) ->
    case letT (Proxy @(T "i87" -> l88)) of { LetT (_ :: Proxy l87) ->
    case letT (Proxy @(T "i86" -> l87)) of { LetT (_ :: Proxy l86) ->
    case letT (Proxy @(T "i85" -> l86)) of { LetT (_ :: Proxy l85) ->
    case letT (Proxy @(T "i84" -> l85)) of { LetT (_ :: Proxy l84) ->
    case letT (Proxy @(T "i83" -> l84)) of { LetT (_ :: Proxy l83) ->
    case letT (Proxy @(T "i82" -> l83)) of { LetT (_ :: Proxy l82) ->
    case letT (Proxy @(T "i81" -> l82)) of { LetT (_ :: Proxy l81) ->
    case letT (Proxy @(T "i80" -> l81)) of { LetT (_ :: Proxy l80) ->
    -- 79 .. 70
    case letT (Proxy @(T "i79" -> l80)) of { LetT (_ :: Proxy l79) ->
    case letT (Proxy @(T "i78" -> l79)) of { LetT (_ :: Proxy l78) ->
    case letT (Proxy @(T "i77" -> l78)) of { LetT (_ :: Proxy l77) ->
    case letT (Proxy @(T "i76" -> l77)) of { LetT (_ :: Proxy l76) ->
    case letT (Proxy @(T "i75" -> l76)) of { LetT (_ :: Proxy l75) ->
    case letT (Proxy @(T "i74" -> l75)) of { LetT (_ :: Proxy l74) ->
    case letT (Proxy @(T "i73" -> l74)) of { LetT (_ :: Proxy l73) ->
    case letT (Proxy @(T "i72" -> l73)) of { LetT (_ :: Proxy l72) ->
    case letT (Proxy @(T "i71" -> l72)) of { LetT (_ :: Proxy l71) ->
    case letT (Proxy @(T "i70" -> l71)) of { LetT (_ :: Proxy l70) ->
    -- 69 .. 60
    case letT (Proxy @(T "i69" -> l70)) of { LetT (_ :: Proxy l69) ->
    ...
    case letT (Proxy @(T "i00" -> l01)) of { LetT (_ :: Proxy l00) ->
      ...
      let -- 00 .. 09
          ...
          -- 70 .. 79
          f70 = castEqual f69 <*> pure (MkT @"i69")
          f71 = castEqual f70 <*> pure (MkT @"i70")
          f72 = castEqual f71 <*> pure (MkT @"i71")
          f73 = castEqual f72 <*> pure (MkT @"i72")
          f74 = castEqual f73 <*> pure (MkT @"i73")
          f75 = castEqual f74 <*> pure (MkT @"i74")
          f76 = castEqual f75 <*> pure (MkT @"i75")
          f77 = castEqual f76 <*> pure (MkT @"i76")
          f78 = castEqual f77 <*> pure (MkT @"i77")
          f79 = castEqual f78 <*> pure (MkT @"i78")
          -- 80 .. 89
          f80 = castEqual f79 <*> pure (MkT @"i79")
          f81 = castEqual f80 <*> pure (MkT @"i80")
          f82 = castEqual f81 <*> pure (MkT @"i81")
          f83 = castEqual f82 <*> pure (MkT @"i82")
          f84 = castEqual f83 <*> pure (MkT @"i83")
          f85 = castEqual f84 <*> pure (MkT @"i84")
          f86 = castEqual f85 <*> pure (MkT @"i85")
          f87 = castEqual f86 <*> pure (MkT @"i86")
          f88 = castEqual f87 <*> pure (MkT @"i87")
          f89 = castEqual f88 <*> pure (MkT @"i88")
          -- 90 .. 99
          f90 = castEqual f89 <*> pure (MkT @"i89")
          f91 = castEqual f90 <*> pure (MkT @"i90")
          f92 = castEqual f91 <*> pure (MkT @"i91")
          f93 = castEqual f92 <*> pure (MkT @"i92")
          f94 = castEqual f93 <*> pure (MkT @"i93")
          f95 = castEqual f94 <*> pure (MkT @"i94")
          f96 = castEqual f95 <*> pure (MkT @"i95")
          f97 = castEqual f96 <*> pure (MkT @"i96")
          f98 = castEqual f97 <*> pure (MkT @"i97")
          f99 = castEqual f98 <*> pure (MkT @"i98")

          res = castEqual f99 <*> pure (MkT @"i99")
