...
hlist = letT' (Proxy @Fields) $ \(_ :: Proxy r) -> castEqual $
    -- 99 .. 90
    letAs' @(HList r) (HCons (MkT @"i99") HNil) $ \(xs99 :: HList t99) ->
    letAs' @(HList r) (HCons (MkT @"i98") xs99) $ \(xs98 :: HList t98) ->
    letAs' @(HList r) (HCons (MkT @"i97") xs98) $ \(xs97 :: HList t97) ->
    letAs' @(HList r) (HCons (MkT @"i96") xs97) $ \(xs96 :: HList t96) ->
    letAs' @(HList r) (HCons (MkT @"i95") xs96) $ \(xs95 :: HList t95) ->
    letAs' @(HList r) (HCons (MkT @"i94") xs95) $ \(xs94 :: HList t94) ->
    letAs' @(HList r) (HCons (MkT @"i93") xs94) $ \(xs93 :: HList t93) ->
    letAs' @(HList r) (HCons (MkT @"i92") xs93) $ \(xs92 :: HList t92) ->
    letAs' @(HList r) (HCons (MkT @"i91") xs92) $ \(xs91 :: HList t91) ->
    letAs' @(HList r) (HCons (MkT @"i90") xs91) $ \(xs90 :: HList t90) ->
    -- 89 .. 80
    letAs' @(HList r) (HCons (MkT @"i89") xs90) $ \(xs89 :: HList t89) ->
