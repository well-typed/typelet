...
hlist =
   -- 99 .. 90
   case letAs (HCons (MkT @"i99") HNil) of { LetAs (xs99 :: HList t99) ->
   case letAs (HCons (MkT @"i98") xs99) of { LetAs (xs98 :: HList t98) ->
   case letAs (HCons (MkT @"i97") xs98) of { LetAs (xs97 :: HList t97) ->
   case letAs (HCons (MkT @"i96") xs97) of { LetAs (xs96 :: HList t96) ->
   case letAs (HCons (MkT @"i95") xs96) of { LetAs (xs95 :: HList t95) ->
   case letAs (HCons (MkT @"i94") xs95) of { LetAs (xs94 :: HList t94) ->
   case letAs (HCons (MkT @"i93") xs94) of { LetAs (xs93 :: HList t93) ->
   case letAs (HCons (MkT @"i92") xs93) of { LetAs (xs92 :: HList t92) ->
   case letAs (HCons (MkT @"i91") xs92) of { LetAs (xs91 :: HList t91) ->
   case letAs (HCons (MkT @"i90") xs91) of { LetAs (xs90 :: HList t90) ->
   -- 89 .. 80
   case letAs (HCons (MkT @"i89") xs90) of { LetAs (xs89 :: HList t89) ->
